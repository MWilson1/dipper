...
lam=int(lam)
file='bass'+str(lam)
pathdir = dp.diprd(26,1).dipper_dbdir + os.path.sep  
print(pathdir + file)
...
boundonly=True
diprd_init=dp.diprd(26,1,boundonly, dipper_regime=dipper_regime, dipper_approx=dipper_approx) # debug, not sure why this doesn't have any levels in the lvlrd
