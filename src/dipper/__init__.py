...
print("Diagnostics Inferring the Physics of Plasma and Emitted Radiation (DIPPER)")
#if version.__version_usedate__:
if __version_usedate__:
    print(f"DIPPER last updated on {__version__}")
else:
    print(f"DIPPER version {__version__}")


dipall.confirmdirs(dipper_imported=True) # check path for XUVTOP
