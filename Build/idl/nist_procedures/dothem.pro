...
;
; Last Modified: Sun Jul 30 14:31:50 2006 by judge (judge) on edlen.local
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
@catom
@cqn
...
FOR j = 0,n_elements(atoms)-1 DO BEGIN 
   atomid = atoms(j)
   xx = abmass(atomid)
   abnd = xx(0) & awgt = xx(1)*uu
   file = strlowcase('nistgf.'+atomid+'1')
   print,'doing ',file
   openr,lu,file,/get
...
;   gencom,colnew
;   atomsort
   atomwr,'atom.'+strlowcase(atomid)+'1'
endfor
END
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
