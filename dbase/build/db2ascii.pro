...
;for k=3, n_elements(name)-1 do begin 
for k=3, 3 do begin 
...
;         stop
   ...
   if(k eq 3)  then begin
      ...
      for i=0,n_elements(v1)-1 do begin
         ...
         s+=string(alog10(v2[0:v4[i]-1,i]),format='(11(1x,f5.2))')
         s+=string(v3[0:v4[i]-1,i],        format='(11(1x,e8.2))')
         printf,lu,strcompress(s)
      endfor
      free_lun,lu
   endif
